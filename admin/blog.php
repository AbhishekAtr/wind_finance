    ...
    if (!empty($_FILES["p_image"]["name"])) {
        ...
        if (in_array($fileType1, $allowTypes)) {
            ...
            if (move_uploaded_file($image, $destinationfile)) {
                ...
                $insert = "INSERT INTO `blog`(  `title`, `description`, `image_url`, `content`) VALUES ('$product_title','$product_desc','$destinationfile','$product_content')";
...
if (isset($_POST["update"])) {
    ...
    $product_content = $_POST['pcontent'];
    if (!empty($_FILES["pimage"]["name"])) {
        ...
        if (in_array($fileType1, $allowTypes)) {
            ...
            if (move_uploaded_file($image, $destinationfile)) {
                ...
                $update = "UPDATE `blog` SET `title`='$product_title',`description`='$product_desc',`image_url`='$destinationfile' `content`='$product_content' WHERE `id`='$id'";
        ...
        $query = "UPDATE `blog` SET `title`='$product_title',`description`='$product_desc', `content`='$product_content' WHERE `id`='$id'";
        ...
        <div class="adminForm card m-3 p-5">
            <form method="post" action="blog.php" enctype="multipart/form-data">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            <label for="productname" class="control-label">Blog Content<sup class="text-danger bold">*</sup></label>
                            <input type="text" class="form-control" id="p_content" name="p_content" placeholder="Enter blog title here" required>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
